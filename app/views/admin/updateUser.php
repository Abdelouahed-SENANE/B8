...
<main class="w-full h-[calc(100vh-64px)] bg-slate-100 p-10">
    ...
    <div class="mt-20">
        ...
        <h1 class="text-2xl font-bold text-center pb-5 text-white">UPDATE</h1>

            <div class="flex items-center gap-4">
                <div class="py-2 flex-grow">
                    <label for="error" class="block mb-2 text-sm font-medium text-white">Username
                        </label>
                    <input type="text" id="error" required value="<?= $data['user']->username ?>"
                ...
                <div class="py-2 flex-grow ">                    
                            ...
                            <option selected disabled value="<?= $data['user']->userID ?>"><?= $data['user']->roleName ?></option>
            ...
            <div class="flex items-center gap-3">
                <div class="py-2 flex-grow">
                    ...
                    <input type="password" id="error" required value="<?= $data['user']->userPass ?>"
                        class="<?php if(!empty($data[''])){echo 'border border-rose-500';}else{echo '';}?> bg-white border text-sm rounded-lg focus:ring-red-500  focus:border-red-500 block w-full p-2.5 "
                ...
                <div class="py-2 flex-grow ">                    
                            ...
                            <option selected disabled value="<?= $data['user']->agencyID ?>"><?= $data['user']->ville ?></option>
            ...
            <div class="flex items-center gap-4">
                <div class="py-2 flex-grow">
                    ...
                    <input type="text" id="error" required value="<?= $data['user']->ville ?>"
                        class="<?php if(!empty($data[''])){echo 'border border-rose-500';}else{echo '';}?> bg-white border text-sm rounded-lg focus:ring-red-500  focus:border-red-500 block w-full p-2.5 "
                ...
                <div class="py-2 flex-grow">
                    ...
                    <input type="text" id="error" required value="<?= $data['user']->quartier ?>"
                        class="<?php if(!empty($data[''])){echo 'border border-rose-500';}else{echo '';}?> bg-white border text-sm rounded-lg focus:ring-red-500  focus:border-red-500 block w-full p-2.5 "
            ...
            <div class="flex items-center gap-4">
                    <div class="py-2 flex-grow">
                            ...
                            <input type="text" id="error" required value="<?= $data['user']->rue ?>"
                                class="<?php if(!empty($data[''])){echo 'border border-rose-500';}else{echo '';}?> bg-white border text-sm rounded-lg focus:ring-red-500  focus:border-red-500 block w-full p-2.5 "
                    ...
                    <div class="py-2 flex-grow">
                            ...
                            <input type="text" id="error" required value="<?= $data['user']->email ?>"
                                class="<?php if(!empty($data[''])){echo 'border border-rose-500';}else{echo '';}?> bg-white border text-sm rounded-lg focus:ring-red-500  focus:border-red-500 block w-full p-2.5 "
            ...
            <div class="flex items-center gap-4">
                ...
                <div class="py-2 flex-grow">
                    ...
                    <input type="text" id="error" required value="<?= $data['user']->phone ?>"
                        class="<?php if(!empty($data[''])){echo 'border border-rose-500';}else{echo '';}?> bg-white border text-sm rounded-lg focus:ring-red-500  focus:border-red-500 block w-full p-2.5 "
                ...
                <div class="py-2 flex-grow">
                    ...
                    <input type="text" id="error" required value="<?= $data['user']->codePostal ?>"
                        class="<?php if(!empty($data[''])){echo 'border border-rose-500';}else{echo '';}?> bg-white border text-sm rounded-lg focus:ring-red-500  focus:border-red-500 block w-full p-2.5 "
                        placeholder="Enter Code postal" name="code">
                    <p class="mt-2 text-sm text-red-600 dark:text-red-500"></p>
                </div>
            </div>
            <button type="submit" name="update" class="w-full mt-10 block items-center px-6 py-2 w-full text-center border
