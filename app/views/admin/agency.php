...
<main class="w-full h-[calc(100vh-64px)] bg-slate-100 p-10">
    ...
    <div class=" w-[95%] mx-auto my-5 flex items-center justify-between p-3 bg-white rounded-lg">
        <h1 class="text-xl font-bold">AGENCIES</h1>
        <div class="flex items-center gap-5">
            ...
            <button>
                <a href="<?php echo URLROOT?>/admin/addAgency" class="inline-flex items-center px-6 py-2 border border-transparent text-sm
                    leading-6 font-medium rounded-md text-white bg-primary  hover:bg-gray-800 focus:outline-none
                     transition duration-150 ease-in-out">Add Agency</a>
            </button>
        </div>
    </div>
                ...
                <?php foreach ($data['agencies'] as $agency) {  ?>
                    ...
                    <tr class="bg-white border-b  hover:bg-gray-50 ">
                        ...
                        <td class="px-6 py-4 px-6 py-4 gap-1 flex items-center justify-center font-medium text-gray-800 whitespace-nowrap ">
                            <!-- ============ Update Button =============  -->
                            <a href="<?= URLROOT ?>/admin/updateBank?id=<?php echo $agency->agencyID; ?>" class="font-medium text-green-400  hover:underline">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L6.832 19.82a4.5 4.5 0 01-1.897 1.13l-2.685.8.8-2.685a4.5 4.5 0 011.13-1.897L16.863 4.487zm0 0L19.5 7.125" />
                            </svg>
                            </a>
                            <!-- ============ Delete Button =============  -->
                            <a href="<?= URLROOT ?>/admin/deleteBank?id=<?php echo $agency->agencyID; ?>" class="font-medium text-rose-500  hover:underline">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
