...
<main class="w-full h-[calc(100vh-64px)] bg-slate-100 p-10">
    ...
    <div class=" w-[95%] mx-auto my-5 flex items-center justify-between p-3 bg-white rounded-lg">
        <h1 class="text-xl font-bold">ADD NEW BANKS</h1>
    ...
    <div class="mt-20">
        ...
        <form class="max-w-lg mx-auto bg-gray-800 p-6 rounded-lg" method="POST" enctype="multipart/form-data">
            <div class="py-3">
                ...
                <p class="mt-2 text-sm text-red-600 dark:text-red-500"><?= $data['bankNameErr'];?></p>
            </div>
            <div>
                ...
                <p class="mt-2 text-sm text-red-600 dark:text-red-500"><?= $data['imgBankErr'];?></p>

            </div>
            <button type="submit" name="bank" class="w-full mt-10 block items-center px-6 py-2 w-full text-center border
